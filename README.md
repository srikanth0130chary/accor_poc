...
See **accor_poc/redemption-infra/diagram/architecture.png**
  for the data-flow / AWS component diagram.

## Repository layout

```
accor_poc/redemption-infra/terraform/
...
accor_poc/redemption-infra/k8s/
...
accor_poc/redemption-infra/diagram/
  architecture.dot     # Graphviz source
  architecture.png      # rendered diagram

accor_poc/redemption-infra/design-document.pdf
```
## Deploy order within directory path accor_poc/redemption-infra
